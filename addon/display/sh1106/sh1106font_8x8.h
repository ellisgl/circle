// addon/display/sh1106/sh1106font_8x8.h
#ifndef SH1106FONT_8X8_H
#define SH1106FONT_8X8_H
#include <circle/types.h>

#define FONT_WIDTH 8
#define FONT_HEIGHT 8
// 8x8 font array for ASCII characters (from 'NUL' to 'DEL')
const u8 CSH1106DeviceFont8x8[][8] = {
    ...
    //{0x10, 0x38, 0x7C, 0xFE, 0xFE, 0x7C, 0x10, 0x38}, // 0x06 ACK
    //{0x00, 0x18, 0x3C, 0x3C, 0x18, 0x00, 0x00, 0x00}, // 0x07 BEL
    //{0xFF, 0xE7, 0xC3, 0xC3, 0xE7, 0xFF, 0xFF, 0xFF}, // 0x08 BS
    //{0x00, 0x18, 0x24, 0x24, 0x18, 0x00, 0x00, 0x00}, // 0x09 HT
    //{0xFF, 0xE7, 0xDB, 0xDB, 0xE7, 0xFF, 0xFF, 0xFF}, // 0x0A LF
    //{0x0F, 0x03, 0x05, 0x79, 0x80, 0x80, 0x80, 0x80}, // 0x0B VT
    ...
    {0x00, 0x00, 0x5F, 0x5F, 0x00, 0x00, 0x00, 0x00}, // 0x21 '!'
    {0x00, 0x07, 0x07, 0x00, 0x07, 0x07, 0x00, 0x00}, // 0x22 '"'
    {0x14, 0x7F, 0x7F, 0x14, 0x7F, 0x7F, 0x14, 0x00}, // 0x23 '#'
    {0x24, 0x2E, 0x2A, 0x7F, 0x7F, 0x2A, 0x3A, 0x12}, // 0x24 '$'
    {0x62, 0x66, 0x30, 0x18, 0x0C, 0x66, 0x46, 0x00}, // 0x25 '%'
    {0x30, 0x7A, 0x4F, 0x4D, 0x77, 0x32, 0x58, 0x00}, // 0x26 '&'
    {0x00, 0x00, 0x07, 0x07, 0x00, 0x00, 0x00, 0x00}, // 0x27 '''
    ...
    {0x3E, 0x7F, 0x71, 0x49, 0x45, 0x7F, 0x3E, 0x00}, // 0x30 '0'
    {0x00, 0x42, 0x43, 0x7F, 0x7F, 0x40, 0x40, 0x00}, // 0x31 '1'
    {0x42, 0x63, 0x71, 0x59, 0x4D, 0x67, 0x62, 0x00}, // 0x32 '2'
    ...
    {0x01, 0x01, 0x79, 0x7D, 0x0D, 0x07, 0x03, 0x00}, // 0x37 '7'
    ...
    {0x00, 0x00, 0xB6, 0x76, 0x00, 0x00, 0x00, 0x00}, // 0x3B ';'
    {0x08, 0x1C, 0x36, 0x63, 0x41, 0x00, 0x00, 0x00}, // 0x3C '<'
    {0x24, 0x24, 0x24, 0x24, 0x24, 0x24, 0x00, 0x00}, // 0x3D '='
    {0x00, 0x00, 0x41, 0x63, 0x36, 0x1C, 0x08, 0x00}, // 0x3E '>'
    {0x02, 0x03, 0x71, 0x79, 0x0D, 0x07, 0x02, 0x00}, // 0x3F '?'
    ...
    {0x3E, 0x7F, 0x41, 0x51, 0x21, 0x7F, 0x5E, 0x00}, // 0x51 'Q'
    {0x7F, 0x7F, 0x09, 0x19, 0x29, 0x6F, 0x46, 0x00}, // 0x52 'R'
    {0x26, 0x6F, 0x4D, 0x4D, 0x59, 0x7B, 0x32, 0x00}, // 0x53 'S'
    {0x03, 0x01, 0x7F, 0x7F, 0x01, 0x03, 0x00, 0x00}, // 0x54 'T'
    {0x3F, 0x7F, 0x40, 0x40, 0x40, 0x7F, 0x3F, 0x00}, // 0x55 'U'
    {0x0F, 0x1F, 0x30, 0x60, 0x30, 0x1F, 0x0F, 0x00}, // 0x56 'V'
    {0x3F, 0x7F, 0x70, 0x3C, 0x70, 0x7F, 0x3F, 0x00}, // 0x57 'W'
    {0x63, 0x77, 0x1C, 0x08, 0x1C, 0x77, 0x63, 0x00}, // 0x58 'X'
    {0x03, 0x07, 0x78, 0x78, 0x07, 0x03, 0x00, 0x00}, // 0x59 'Y'
    {0x61, 0x71, 0x59, 0x4D, 0x47, 0x63, 0x00, 0x00}, // 0x5A 'Z'
    {0x7F, 0x7F, 0x41, 0x41, 0x00, 0x00, 0x00, 0x00}, // 0x5B '['
    {0x03, 0x0F, 0x3C, 0x70, 0xC0, 0x00, 0x00, 0x00}, // 0x5C '\'
    {0x41, 0x41, 0x7F, 0x7F, 0x00, 0x00, 0x00, 0x00}, // 0x5D ']'
    {0x04, 0x06, 0x03, 0x03, 0x06, 0x04, 0x00, 0x00}, // 0x5E '^'
    {0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80}, // 0x5F '_'
    {0x01, 0x03, 0x06, 0x04, 0x00, 0x00, 0x00, 0x00}, // 0x60 '`'
    {0x20, 0x74, 0x54, 0x54, 0x3C, 0x78, 0x40, 0x00}, // 0x61 'a'
    {0x7F, 0x7F, 0x44, 0x44, 0x3C, 0x38, 0x00, 0x00}, // 0x62 'b'
    {0x38, 0x7C, 0x44, 0x44, 0x44, 0x44, 0x00, 0x00}, // 0x63 'c'
    {0x38, 0x7C, 0x44, 0x44, 0x7F, 0x7F, 0x00, 0x00}, // 0x64 'd'
    {0x38, 0x7C, 0x54, 0x54, 0x5C, 0x58, 0x00, 0x00}, // 0x65 'e'
    {0x04, 0x7E, 0x7F, 0x05, 0x01, 0x00, 0x00, 0x00}, // 0x66 'f'
    {0x18, 0xBC, 0xA4, 0xA4, 0xFC, 0x7C, 0x00, 0x00}, // 0x67 'g'
    {0x7F, 0x7F, 0x04, 0x04, 0x7C, 0x78, 0x00, 0x00}, // 0x68 'h'
    {0x00, 0x44, 0x7D, 0x7D, 0x40, 0x00, 0x00, 0x00}, // 0x69 'i'
    {0x40, 0xC0, 0x80, 0x80, 0xFD, 0x7D, 0x00, 0x00}, // 0x6A 'j'
    {0x7F, 0x7F, 0x10, 0x38, 0x6C, 0x44, 0x00, 0x00}, // 0x6B 'k'
    ...
    {0xFC, 0xFC, 0x24, 0x24, 0x3C, 0x18, 0x00, 0x00}, // 0x70 'p'
    {0x18, 0x3C, 0x24, 0x24, 0xFC, 0xFC, 0x00, 0x00}, // 0x71 'q'
    {0x7C, 0x7C, 0x08, 0x04, 0x04, 0x0C, 0x00, 0x00}, // 0x72 'r'
    {0x48, 0x5C, 0x54, 0x54, 0x74, 0x24, 0x00, 0x00}, // 0x73 's'
    {0x04, 0x3E, 0x7F, 0x44, 0x24, 0x00, 0x00, 0x00}, // 0x74 't'
    {0x3C, 0x7C, 0x40, 0x40, 0x7C, 0x7C, 0x00, 0x00}, // 0x75 'u'
    ...
    {0x1C, 0xBC, 0xA0, 0xA0, 0xFC, 0x7C, 0x00, 0x00}, // 0x79 'y'
    {0x44, 0x64, 0x74, 0x5C, 0x4C, 0x44, 0x00, 0x00}, // 0x7A 'z'
    {0x08, 0x08, 0x36, 0x77, 0x41, 0x41, 0x00, 0x00}, // 0x7B '{'
    {0x00, 0x00, 0x7F, 0x7F, 0x00, 0x00, 0x00, 0x00}, // 0x7C '|'
    {0x41, 0x41, 0x77, 0x36, 0x08, 0x08, 0x00, 0x00}, // 0x7D '}'
    {0x02, 0x03, 0x01, 0x03, 0x02, 0x01, 0x03, 0x00}, // 0x7E '~'
   // {0x3C, 0x7E, 0x4A, 0x4A, 0x4A, 0x7E, 0x3C, 0x00}  // 0x7F DEL
};
